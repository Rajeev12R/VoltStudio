...
{/* <div className="absolute inset-0 bg-gradient-to-b from-[#060606] via-purple-900/30 to-[#060606] pointer-events-none" /> */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 ">
        ...
        >
          ...
          Discover how businesses of all sizes, from local cafés to international schools, have partnered with <span className="text-white font-bold">PaperClip</span> – the marketing agency that drives growth and success.
          </p>
          <Link
            to="/contact"
